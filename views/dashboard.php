  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header centered" style="color:blue" required>
            ...
            <!--logo start-->
            <a href="dashboard.php" class="logo" style="color:blue" ><b>SIPES</b></a>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><img src="assets/img/logo1.jpg" class="img-circle" width="60" ></a></p>
         ...
         <ul>
              ...
              <i class="glyphicon glyphicon-eye-open"></i>
			   ...
			   <ul>
              <li><a href="datasiswa.php">
              <i class="fa fa-user"></i>
               Data Siswa</a>
              </li>
              <li><a href="searchdate.php">
              ...
              <li>
              <a href="laporantransaksibulanan.php">
              <i class="glyphicon glyphicon-book"></i>
              <span>Laporan Pembayaran Per Kelas</span>
              </a>
