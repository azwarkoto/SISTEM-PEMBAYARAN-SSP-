...
<p>&nbsp;  </p>
    ...
    ?>
    <form action="laporantransaksibulanansiswa.php" method="post" name="postform" required>
...
<?php
      ...
      <script language="JavaScript" required>
        ...
        document.location='laporantransaksibulanansiswa.php';
      </script>
      <?php
      }else{
...
<form role="form" action="cetakpembayaransiswa.php" method="POST" target="_blank">
              <table border="0">
                  <tr><td align="right" colspan="6"><button type="submit" class="btn btn-danger">
                  <i class="glyphicon glyphicon-cloud-upload"></i> Cetak Laporan Transaksi </i>  
                  </button></td></tr>
